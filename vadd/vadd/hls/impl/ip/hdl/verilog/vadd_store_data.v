...
wire   [0:0] icmp_ln60_1_fu_161_p2;
reg    gmem0_blk_n_AW;
...
reg    out_r_blk_n;
reg    size_blk_n;
reg   [31:0] size_1_reg_184;
reg    ap_block_state1;
reg   [63:0] gmem0_addr_reg_189;
wire   [30:0] empty_fu_137_p3;
reg   [30:0] empty_reg_196;
reg   [31:0] out_stream_read_reg_204;
reg    ap_block_state3;
wire  signed [63:0] sext_ln60_fu_127_p1;
reg   [30:0] i_fu_66;
wire   [30:0] add_ln60_fu_166_p2;
wire   [61:0] trunc_ln_fu_117_p4;
wire   [0:0] icmp_ln60_fu_107_p2;
wire   [30:0] trunc_ln60_fu_113_p1;
wire   [31:0] zext_ln60_1_fu_157_p1;
reg   [71:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_66 <= 31'd0;
    end else if (((1'b0 == ap_block_state3) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln60_1_fu_161_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem0_0_AWREADY == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (m_axi_gmem0_0_WREADY == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln60_1_fu_161_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state3) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln60_1_fu_161_p2 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b0 == ap_block_state3) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln60_1_fu_161_p2 == 1'd0))) begin
...
assign add_ln60_fu_166_p2 = (i_fu_66 + 31'd1);
...
always @ (*) begin
    ap_block_state3 = ((out_stream_empty_n == 1'b0) & (icmp_ln60_1_fu_161_p2 == 1'd1));
end

assign empty_fu_137_p3 = ((icmp_ln60_fu_107_p2[0:0] == 1'b1) ? trunc_ln60_fu_113_p1 : 31'd0);

assign icmp_ln60_1_fu_161_p2 = (($signed(zext_ln60_1_fu_157_p1) < $signed(size_1_reg_184)) ? 1'b1 : 1'b0);

assign icmp_ln60_fu_107_p2 = (($signed(size_dout) > $signed(32'd0)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_0_AWADDR = gmem0_addr_reg_189;
...
assign m_axi_gmem0_0_AWLEN0 = empty_reg_196;
...
assign m_axi_gmem0_0_WDATA = out_stream_read_reg_204;
...
assign sext_ln60_fu_127_p1 = $signed(trunc_ln_fu_117_p4);

assign trunc_ln60_fu_113_p1 = size_dout[30:0];

assign trunc_ln_fu_117_p4 = {{out_r_dout[63:2]}};

assign zext_ln60_1_fu_157_p1 = i_fu_66;

endmodule //vadd_store_data
