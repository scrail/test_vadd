...
architecture behav of vadd_load_data_1 is 
...
attribute shreg_extract : string;
    ...
    signal size_read_reg_168 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal empty_fu_100_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_reg_173 : STD_LOGIC_VECTOR (30 downto 0);
    signal gmem1_addr_read_reg_192 : STD_LOGIC_VECTOR (31 downto 0);
    signal sext_ln41_fu_123_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_56 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln41_fu_150_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state73 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state73 : signal is "none";
    signal icmp_ln41_1_fu_145_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln41_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln41_fu_96_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln_fu_113_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal zext_ln38_fu_141_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal m_axi_gmem1_0_ARLEN0 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((icmp_ln41_1_fu_145_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln41_1_fu_145_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state74) and (m_axi_gmem1_0_RVALID = ap_const_logic_1))) then
                gmem1_addr_read_reg_192 <= m_axi_gmem1_0_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem1_0_ARREADY, m_axi_gmem1_0_RVALID, in2_stream_full_n, ap_CS_fsm_state2, ap_CS_fsm_state74, ap_CS_fsm_state75, ap_block_state1, ap_CS_fsm_state73, icmp_ln41_1_fu_145_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem1_0_ARREADY = ap_const_logic_1))) then
            ...
            when ap_ST_fsm_state73 => 
                if (((icmp_ln41_1_fu_145_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state73))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_state75 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state75) and (in2_stream_full_n = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state73;
                else
                    ap_NS_fsm <= ap_ST_fsm_state75;
                end if;
    ...
    add_ln41_fu_150_p2 <= std_logic_vector(unsigned(i_fu_56) + unsigned(ap_const_lv31_1));
    ...
    ap_ST_fsm_state2_blk_assign_proc : process(m_axi_gmem1_0_ARREADY)
    begin
    ...
    ap_ST_fsm_state74_blk_assign_proc : process(m_axi_gmem1_0_RVALID)
    begin
    ...
    ap_ST_fsm_state75_blk_assign_proc : process(in2_stream_full_n)
    begin
        if ((in2_stream_full_n = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state73, icmp_ln41_1_fu_145_p2)
    begin
        if (((icmp_ln41_1_fu_145_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state73, icmp_ln41_1_fu_145_p2)
    begin
        if (((icmp_ln41_1_fu_145_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state73))) then 
    ...
    empty_fu_100_p3 <= 
        trunc_ln41_fu_96_p1 when (icmp_ln41_fu_90_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    gmem1_blk_n_R_assign_proc : process(m_axi_gmem1_0_RVALID, ap_CS_fsm_state74)
    begin
    ...
    icmp_ln41_1_fu_145_p2 <= "1" when (signed(zext_ln38_fu_141_p1) < signed(size_read_reg_168)) else "0";
    icmp_ln41_fu_90_p2 <= "1" when (signed(size) > signed(ap_const_lv32_0)) else "0";

    in2_stream_blk_n_assign_proc : process(in2_stream_full_n, ap_CS_fsm_state75)
    begin
    ...
    in2_stream_din <= gmem1_addr_read_reg_192;

    in2_stream_write_assign_proc : process(in2_stream_full_n, ap_CS_fsm_state75)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state75) and (in2_stream_full_n = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_0_ARADDR <= sext_ln41_fu_123_p1;
    m_axi_gmem1_0_ARBURST <= ap_const_lv2_0;
    m_axi_gmem1_0_ARCACHE <= ap_const_lv4_0;
    m_axi_gmem1_0_ARID <= ap_const_lv1_0;
    m_axi_gmem1_0_ARLEN <= m_axi_gmem1_0_ARLEN0(32 - 1 downto 0);
    m_axi_gmem1_0_ARLEN0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_173),64));
    ...
    m_axi_gmem1_0_ARVALID_assign_proc : process(m_axi_gmem1_0_ARREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem1_0_ARREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_0_RREADY_assign_proc : process(m_axi_gmem1_0_RVALID, ap_CS_fsm_state74)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state74) and (m_axi_gmem1_0_RVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem1_0_WVALID <= ap_const_logic_0;
        sext_ln41_fu_123_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_113_p4),64));

    trunc_ln41_fu_96_p1 <= size(31 - 1 downto 0);
    trunc_ln_fu_113_p4 <= in_r(63 downto 2);
    zext_ln38_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_56),32));
end behav;
