...
reg    size_c1_blk_n;
reg   [31:0] size_read_reg_186;
reg    ap_block_state1;
wire   [30:0] empty_fu_118_p3;
reg   [30:0] empty_reg_191;
reg   [31:0] gmem0_addr_read_reg_210;
wire  signed [63:0] sext_ln41_fu_141_p1;
reg   [30:0] i_fu_66;
wire   [30:0] add_ln41_fu_168_p2;
wire    ap_CS_fsm_state73;
wire   [0:0] icmp_ln41_2_fu_163_p2;
wire   [0:0] icmp_ln41_fu_108_p2;
wire   [30:0] trunc_ln41_fu_114_p1;
wire   [61:0] trunc_ln_fu_131_p4;
wire   [31:0] zext_ln38_fu_159_p1;
reg   [74:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln41_2_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state73))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_66 <= 31'd0;
    end else if (((icmp_ln41_2_fu_163_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state73))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state74) & (m_axi_gmem0_0_RVALID == 1'b1))) begin
...
always @ (*) begin
    if ((in1_stream_full_n == 1'b0)) begin
...
always @ (*) begin
    if (((icmp_ln41_2_fu_163_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state73))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state75) & (in1_stream_full_n == 1'b1))) begin
...
assign add_ln41_fu_168_p2 = (i_fu_66 + 31'd1);
...
assign empty_fu_118_p3 = ((icmp_ln41_fu_108_p2[0:0] == 1'b1) ? trunc_ln41_fu_114_p1 : 31'd0);

assign icmp_ln41_2_fu_163_p2 = (($signed(zext_ln38_fu_159_p1) < $signed(size_read_reg_186)) ? 1'b1 : 1'b0);

assign icmp_ln41_fu_108_p2 = (($signed(size) > $signed(32'd0)) ? 1'b1 : 1'b0);

assign in1_stream_din = gmem0_addr_read_reg_210;

assign m_axi_gmem0_0_ARADDR = sext_ln41_fu_141_p1;
...
assign m_axi_gmem0_0_ARLEN0 = empty_reg_191;
...
assign sext_ln41_fu_141_p1 = $signed(trunc_ln_fu_131_p4);

assign size_c1_din = size;

assign start_out = real_start;

assign trunc_ln41_fu_114_p1 = size[30:0];

assign trunc_ln_fu_131_p4 = {{in_r[63:2]}};

assign zext_ln38_fu_159_p1 = i_fu_66;

endmodule //vadd_load_data
