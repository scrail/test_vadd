...
architecture behav of vadd_store_data is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln60_1_fu_161_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal size_1_reg_184 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal gmem0_addr_reg_189 : STD_LOGIC_VECTOR (63 downto 0);
    signal empty_fu_137_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal empty_reg_196 : STD_LOGIC_VECTOR (30 downto 0);
    signal out_stream_read_reg_204 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state3 : BOOLEAN;
    signal sext_ln60_fu_127_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_66 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln60_fu_166_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln_fu_117_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal icmp_ln60_fu_107_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln60_fu_113_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln60_1_fu_157_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_boolean_0 = ap_block_state3) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln60_1_fu_161_p2 = ap_const_lv1_1))) then 
                i_fu_66 <= add_ln60_fu_166_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                empty_reg_196 <= empty_fu_137_p3;
                gmem0_addr_reg_189 <= sext_ln60_fu_127_p1;
                size_1_reg_184 <= size_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state3) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                out_stream_read_reg_204 <= out_stream_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_0_AWREADY, m_axi_gmem0_0_WREADY, m_axi_gmem0_0_BVALID, ap_CS_fsm_state3, icmp_ln60_1_fu_161_p2, ap_CS_fsm_state2, ap_CS_fsm_state4, ap_CS_fsm_state72, ap_block_state1, ap_block_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_0_AWREADY = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_const_boolean_0 = ap_block_state3) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln60_1_fu_161_p2 = ap_const_lv1_0))) then
            ...
            when ap_ST_fsm_state4 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state4) and (m_axi_gmem0_0_WREADY = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    add_ln60_fu_166_p2 <= std_logic_vector(unsigned(i_fu_66) + unsigned(ap_const_lv31_1));
    ...
    ap_ST_fsm_state4_blk_assign_proc : process(m_axi_gmem0_0_WREADY)
    begin
    ...
    ap_block_state3_assign_proc : process(out_stream_empty_n, icmp_ln60_1_fu_161_p2)
    begin
                ap_block_state3 <= ((out_stream_empty_n = ap_const_logic_0) and (icmp_ln60_1_fu_161_p2 = ap_const_lv1_1));
    end process;
    ...
    empty_fu_137_p3 <= 
        trunc_ln60_fu_113_p1 when (icmp_ln60_fu_107_p2(0) = '1') else 
        ap_const_lv31_0;
    ...
    gmem0_blk_n_W_assign_proc : process(m_axi_gmem0_0_WREADY, ap_CS_fsm_state4)
    begin
    ...
    icmp_ln60_1_fu_161_p2 <= "1" when (signed(zext_ln60_1_fu_157_p1) < signed(size_1_reg_184)) else "0";
    icmp_ln60_fu_107_p2 <= "1" when (signed(size_dout) > signed(ap_const_lv32_0)) else "0";
    ...
    m_axi_gmem0_0_AWADDR <= gmem0_addr_reg_189;
    ...
    m_axi_gmem0_0_AWLEN0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_reg_196),64));
    ...
    m_axi_gmem0_0_AWVALID_assign_proc : process(m_axi_gmem0_0_AWREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (m_axi_gmem0_0_AWREADY = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_0_BREADY_assign_proc : process(m_axi_gmem0_0_BVALID, ap_CS_fsm_state72)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state72) and (m_axi_gmem0_0_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_0_WDATA <= out_stream_read_reg_204;
    ...
    m_axi_gmem0_0_WVALID_assign_proc : process(m_axi_gmem0_0_WREADY, ap_CS_fsm_state4)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state4) and (m_axi_gmem0_0_WREADY = ap_const_logic_1))) then 
    ...
    out_stream_blk_n_assign_proc : process(out_stream_empty_n, ap_CS_fsm_state3, icmp_ln60_1_fu_161_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln60_1_fu_161_p2 = ap_const_lv1_1))) then 
    ...
    out_stream_read_assign_proc : process(ap_CS_fsm_state3, icmp_ln60_1_fu_161_p2, ap_block_state3)
    begin
        if (((ap_const_boolean_0 = ap_block_state3) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln60_1_fu_161_p2 = ap_const_lv1_1))) then 
        ...
        sext_ln60_fu_127_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln_fu_117_p4),64));
    ...
    trunc_ln60_fu_113_p1 <= size_dout(31 - 1 downto 0);
    trunc_ln_fu_117_p4 <= out_r_dout(63 downto 2);
    zext_ln60_1_fu_157_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_fu_66),32));
end behav;
