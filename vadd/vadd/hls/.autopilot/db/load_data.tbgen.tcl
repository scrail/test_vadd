...
set cdfgNum 8
set C_modelName {load_data}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ in1_stream int 32 regular {fifo 1 volatile }  }
	{ size int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "in1_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ in1_stream_din sc_out sc_lv 32 signal 2 } 
	{ in1_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ in1_stream_write sc_out sc_logic 1 signal 2 } 
	{ in1_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ in1_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
	{ size sc_in sc_lv 32 signal 3 } 
	{ size_c1_din sc_out sc_lv 32 signal 4 } 
	{ size_c1_full_n sc_in sc_logic 1 signal 4 } 
	{ size_c1_write sc_out sc_logic 1 signal 4 } 
	{ size_c1_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ size_c1_fifo_cap sc_in sc_lv 3 signal 4 } 
}
set NewPortList {[ 
...
set ArgLastReadFirstWriteLatency {
	load_data {
		...
		in1_stream {Type O LastRead -1 FirstWrite 74}
...
set Spec2ImplPortList { 
	...
	in1_stream { ap_fifo {  { in1_stream_din fifo_data_in 1 32 }  { in1_stream_full_n fifo_status 0 1 }  { in1_stream_write fifo_port_we 1 1 }  { in1_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in1_stream_fifo_cap fifo_update 0 3 } } }
