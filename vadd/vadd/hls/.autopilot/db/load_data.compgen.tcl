...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in1_stream_din { O 32 vector } in1_stream_full_n { I 1 bit } in1_stream_write { O 1 bit } in1_stream_num_data_valid { I 3 vector } in1_stream_fifo_cap { I 3 vector } } \
} "
}
