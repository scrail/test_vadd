...
set cdfgNum 8
set C_modelName {load_data.1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem1 int 32 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ in2_stream int 32 regular {fifo 1 volatile }  }
	{ size int 32 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in2","offset": { "type": "dynamic","port_name": "in2","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "in2_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ in2_stream_din sc_out sc_lv 32 signal 2 } 
	{ in2_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ in2_stream_write sc_out sc_logic 1 signal 2 } 
...
set ArgLastReadFirstWriteLatency {
	load_data_1 {
		...
		in2_stream {Type O LastRead -1 FirstWrite 74}
...
set Spec2ImplPortList { 
	...
	in2_stream { ap_fifo {  { in2_stream_din fifo_data_in 1 32 }  { in2_stream_full_n fifo_status 0 1 }  { in2_stream_write fifo_port_we 1 1 }  { in2_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in2_stream_fifo_cap fifo_update 0 3 } } }
