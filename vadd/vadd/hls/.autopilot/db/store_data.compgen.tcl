...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_stream_dout { I 32 vector } out_stream_empty_n { I 1 bit } out_stream_read { O 1 bit } out_stream_num_data_valid { I 3 vector } out_stream_fifo_cap { I 3 vector } } \
} "
}
